...
resource "kubernetes_config_map" "misarch_address_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.address_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.address_db_service_name}/${var.MISARCH_DB_DATABASE}"
...
resource "kubernetes_config_map" "misarch_catalog_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.catalog_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.catalog_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_discount_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.discount_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.discount_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_inventory_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.inventory_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.inventory_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_invoice_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.invoice_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.invoice_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_media_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.media_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.media_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_notification_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.notification_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.notification_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_order_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.order_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.order_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_payment_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.payment_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.payment_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_review_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.review_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.review_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_return_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.return_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.return_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_shipment_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.shipment_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.shipment_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_shoppingcart_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.shoppingcart_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.shoppingcart_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_tax_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.tax_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.tax_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_user_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.user_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.user_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
...
resource "kubernetes_config_map" "misarch_wishlist_env_vars" {
  ...
  data = {
    "SPRING_R2DBC_URL"      = "r2dbc:postgresql://${local.wishlist_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_FLYWAY_URL"     = "jdbc:postgresql://${local.wishlist_db_service_name}/${var.MISARCH_DB_DATABASE}"
    "SPRING_R2DBC_USERNAME" = var.MISARCH_DB_USER
